...
_Leveraging an XGBoost regression model, we accurately predicted average home prices across the state of Texas. Utilizing U.S. Census zipcode boundary data, the results were visualized in a Folium choropleth map. This project provides a comprehensive, step-by-step guide to the modeling process, from data preprocessing to final evaluation._
